...
(defun lin-init-command ()
  ...
  (interactive)
  (android-temp-buffer)
  (comint-send-string (current-buffer) (concat "chmod +x "android-ndk-root-path"/ndk-build\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/adr.sh\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/api.sh\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/apu.sh\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/init.sh\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/lgs.sh\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/mhp.sh\n"))
  (comint-send-string (current-buffer) (concat "chmod +x "ndk-script-path"/ndbr.sh\n")))
  ;;(delete-window))
