...
(setq org-capture-templates
      (quote (("t" "todo" entry 
	      ...
	      ("R" "Research Note" entry 
	           (file+datetree "~/org/research_notes.org")
		   "* %?\n%U\n" 
		   :clock-in t :clock-resume t)
		...
		(tags "+GOAL"
                ...
                (tags-todo "-WAITING-CANCELLED-SOMEDAY/!NEXT"
                           ((org-agenda-overriding-header "Next Tasks")
                            ...
                            (org-agenda-sorting-strategy
                             '(todo-state-down effort-up category-keep))))
                (tags-todo "-REFILE-CANCELLED-SOMEDAY/!-HOLD-WAITING"
...
;; bibtex
(setq org-latex-pdf-process (list "latexmk -pdflatex='lualatex -shell-escape -interaction nonstopmode' -pdf -f  %f" "echo %f %o %b > $HOME/tmp/cmd"))
